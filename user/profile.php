...
<title>My Profile – CorpPortal</title>
  ...
  <main class="main-content">
    <div class="topbar">
      <div class="topbar-left">
        ...
        <div>
          <div class="breadcrumb">
            <a href="<?= $root ?>user/dashboard.php">Dashboard</a>
      ...
      <div class="topbar-right">
        <div class="topbar-avatar employee"><?= $initials ?></div>
      </div>
    </div>
    ...
    <div class="page-body">
      ...
      <div class="profile-grid">
        ...
        <div class="profile-card-left">
          <div class="profile-banner employee"></div>
          <div class="profile-avatar-wrap">
            <div class="profile-avatar employee"><?= $initials ?></div>
          </div>
          <div class="profile-card-body">
            <div class="profile-name"><?= e($profile['name']) ?></div>
            <div class="profile-role-label">Employee</div>
            <hr class="profile-divider">
            <div class="profile-meta">
              <div class="profile-meta-item">
                <div class="meta-icon" style="color:var(--coral-500)">
              ...
              <div class="profile-meta-item">
                ...
                <div>
                  ...
                  <span class="meta-value"><span class="badge badge-user">Employee</span></span>
                </div>
              </div>
              <div class="profile-meta-item">
                <div class="meta-icon" style="color:var(--coral-500)">
        ...
        <div>
          <div class="profile-info-card">
            <div class="info-section">
              <div class="info-section-title" style="color:var(--coral-500)">Account Information</div>
              <div class="info-grid">
                ...
                <div class="info-field">
                  ...
                  <div class="info-field-value"><span class="badge badge-user">Employee</span></div>
                </div>
                <div class="info-field">
            ...
            <div class="info-section">
              <div class="info-section-title" style="color:var(--coral-500)">Update My Profile</div>
              <form method="POST" action="" data-loading>
                ...
                <button type="submit" class="btn btn-coral" data-submit-btn>
